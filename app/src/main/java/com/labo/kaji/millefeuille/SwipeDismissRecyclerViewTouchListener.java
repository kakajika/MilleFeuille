    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_UP: {
                ...
                if (dismiss && mDownPosition != ListView.INVALID_POSITION && !mDismissing) {
                    // dismiss
                            ...
                            .setListener(new AnimatorListenerAdapter() {
                                ...
                                public void onAnimationEnd(Animator animation) {
                                    mRecyclerView.post(new Runnable() {
                                        @Override
                                        public void run() {
                                            mCallbacks.onDismiss(mRecyclerView, downPosition);
                                            mDismissing = false;
                                        }
                                    });
                                }
...
//    private AnimatorListenerAdapter createDismissListener(final View dismissView, final int dismissPosition) {
